...
define("URL_CSS", URL_REL_BASE . "assets" . URL_SEPARATOR . "css" . URL_SEPARATOR);
define("URL_JS", URL_REL_BASE . "assets" . URL_SEPARATOR . "js" . URL_SEPARATOR);
define("URL_IMAGES", URL_REL_BASE .  "assets" . URL_SEPARATOR."images" . URL_SEPARATOR);
